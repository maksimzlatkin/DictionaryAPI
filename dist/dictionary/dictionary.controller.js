...
let DictionaryController = class DictionaryController {
    getWordDefinitions(word, type) {
        let dictionary = new dictionary_service_1.DictionaryService(word, type);
        return dictionary.getDefinitions(type);
    }
};
__decorate([
    (0, common_1.Get)('/:word/:type'),
    __param(0, (0, common_1.Param)('word')),
    __param(1, (0, common_1.Param)('type')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], DictionaryController.prototype, "getWordDefinitions", null);
